...
- Current rating/count (as of 2026-09-08): **5.0 stars, 4 reviews**. This number is hardcoded in THREE places that must always match each other exactly, or the review markup can be seen as inconsistent/self-serving by Google:
